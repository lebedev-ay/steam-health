"""Кандидаты в разметку и версии их текстов. Текст берётся из core.review_text через core.fct_review, версия снимается только у отзывов, попавших в разметку."""
