-- доля строк с game_sk = -1 (заглушка Unknown) в core.fct_review и core.fct_patch.
-- Штатного источника таких строк больше нет: load_fct_patch.py больше не грузит в fct_patch фид платформы.
-- Резкий рост доли - признак того, что загрузчики отработали в неверном порядке (fct_review/fct_patch раньше dim_game).
